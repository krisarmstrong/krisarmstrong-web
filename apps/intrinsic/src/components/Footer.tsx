...
const SOCIAL_LINKS = [
  {
    label: 'Facebook',
    href: 'https://facebook.com/intrinsicmomentummindset',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/intrinsicmomentummindset',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/company/intrinsicmomentummindset',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: 'YouTube',
    href: 'https://youtube.com/@intrinsicmomentummindset',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'Pinterest',
    href: 'https://pinterest.com/intrinsicmomentummindset',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
