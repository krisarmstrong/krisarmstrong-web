      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6 text-text-muted leading-relaxed">
            <p className="text-lg">
              I work with individuals, professionals, executives, and leaders who are tired of
              generic advice and ready for transformation that actually sticks.
            </p>
            <p>
              My approach combines evidence-based psychology, practical strategy, and deep emotional
              intelligence. We don't chase quick wins—we build sustainable systems for long-term
              success.
            </p>
            <p>
              This isn't about mantras or manifestation. It's about doing the real work:
              understanding your patterns, challenging your assumptions, and building the skills
              that separate good leaders from exceptional ones.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-text-muted">
                Real transformation requires honest self-assessment and practical strategies, not
                wishful thinking.
              </p>
            </div>
            <div>
              ...
              <p className="text-text-muted">
                My methods are rooted in psychology, neuroscience, and proven frameworks that create
                lasting change.
              </p>
            </div>
            <div>
              ...
              <p className="text-text-muted">
                Insight without implementation is useless. We focus on building momentum through
            ...
            <div>
              ...
              <p className="text-text-muted">
                There's no one-size-fits-all approach. We'll create a custom roadmap aligned with
