...
const socialLinks = [
  {
    ...
    icon: (
      <svg className="w-6 h-6 text-brand-primary hover:text-brand-accent transition-colors" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: 'Twitter',
    href: 'https://twitter.com/krisarmstrong',
    icon: (
      <svg className="w-6 h-6 text-brand-primary hover:text-brand-accent transition-colors" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@krisarmstrong-CISSP',
    icon: (
      <svg className="w-6 h-6 text-brand-primary hover:text-brand-accent transition-colors" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
