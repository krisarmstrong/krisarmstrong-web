...
function InfoCard({ icon, title, children }: InfoCardProps): React.ReactElement {
  return (
    <section className="bg-surface-raised border border-surface-border p-6 rounded-lg shadow-lg">
      <H2 icon={icon} className="!text-xl !mb-3">{title}</H2>
      ...
      <div className="max-w-4xl mx-auto">
        <header className="mb-6 sm:mb-8">
          ...
          <P className="text-lg text-text-primary">
            ...
            documenting problems, exploits, and misconfigurations in Wi-Fi, cybersecurity, and wired networking.
            Each case highlights root cause analysis and professional-grade tools used in high-stakes environments.
          </P>
        </header>
        ...
        <div className="grid gap-6 md:grid-cols-2 mb-6">
          ...
          <InfoCard icon={<Terminal size={24} className="text-brand-primary" />} title="Tools Featured">
        ...
        <div className="space-y-6">
            ...
            <P>
                Network Engineers, Wi-Fi Professionals, Penetration Testers, Field Technicians, IT Managers,
                and anyone tasked with validating, troubleshooting, or defending modern wired and wireless environments.
            </P>
            </InfoCard>

            <InfoCard icon={<UserPlus size={24} className="text-brand-primary" />} title="Get Involved">
            <P className="mb-4">
                Have an interesting case study or want to connect with the Vigilante network? Let's collaborate.
            </P>
