...
const posts2023 = [
  {
    ...
    excerpt: "Two years since the FCC opened 6 GHz spectrum, Wi-Fi 6E has evolved from experimental technology to enterprise standard. My 2023 deployments show mature ecosystems, refined best practices, and clear ROI patterns emerging across industries.",
    date: "2023-01-23",
  ...
  },
  {
    ...
    excerpt: "Automated Frequency Coordination (AFC) systems now enable standard power operations in 6 GHz, dramatically extending outdoor coverage and capacity. My first AFC-enabled deployments reveal both the tremendous potential and practical implementation challenges.",
    date: "2023-02-20",
    author: "Kris Armstrong",
  ...
  },
  {
    ...
    excerpt: "Zero Trust has moved from theory to standard practice in enterprise wireless. My 2023 implementations show mature frameworks, refined microsegmentation strategies, and practical integration patterns that balance security with user experience.",
    date: "2023-03-22",
    author: "Kris Armstrong",
  ...
  },
  {
    ...
    excerpt: "Three years into AI/ML adoption in wireless networking, we can finally measure real impact. My 2023 analysis of production AI systems reveals surprising truths about automated optimization, predictive analytics, and the human-AI collaboration model.",
    date: "2023-04-18",
    author: "Kris Armstrong",
  ...
  },
  {
    ...
    excerpt: "The 6 GHz band enables unprecedented channel widths, but bigger isn't always better. My 2023 production deployments reveal when to use 160 MHz versus 320 MHz channels—and why 80 MHz still has a place in modern design.",
    date: "2023-05-25",
    author: "Kris Armstrong",
  ...
  },
  {
    ...
    excerpt: "WPA3-Enterprise adoption has reached critical mass with 90% client support in corporate environments. My 2023 deployments show how organizations are leveraging 192-bit security, simplified onboarding, and enhanced identity frameworks.",
    date: "2023-06-21",
    author: "Kris Armstrong",
  ...
  },
  {
    ...
    excerpt: "Infrastructure as Code principles have transformed enterprise wireless management. My 2023 implementations demonstrate how GitOps, declarative configuration, and CI/CD pipelines deliver consistent, auditable network operations at scale.",
    date: "2023-07-19",
    author: "Kris Armstrong",
  ...
  },
  {
    ...
    excerpt: "Wi-Fi 6E's maturity enables true multi-vendor deployments without compromise. My 2023 interoperability testing across major vendors reveals excellent compatibility in 6 GHz, with important considerations for roaming and advanced features.",
    date: "2023-08-23",
    author: "Kris Armstrong",
  ...
  },
  {
    ...
    excerpt: "Modern enterprises require unified wireless infrastructure spanning Wi-Fi 6E, private cellular, and IoT networks. My 2023 converged deployments show how to integrate these technologies while maintaining security, performance, and manageability.",
    date: "2023-09-20",
    author: "Kris Armstrong",
  ...
  },
  {
    ...
    excerpt: "As Wi-Fi 7 (802.11be) moves toward ratification, early chipsets and draft implementations are emerging. While commercial products remain months away, understanding Wi-Fi 7's revolutionary features helps prepare for the next wireless evolution.",
    date: "2023-10-24",
    author: "Kris Armstrong",
  ...
  },
  {
    ...
    excerpt: "Three years of Wi-Fi 6E deployments have revealed unique 6 GHz troubleshooting patterns. My 2023 diagnostic methodology addresses common issues from client discovery to roaming behavior, providing systematic approaches to 6 GHz optimization.",
    date: "2023-11-21",
    author: "Kris Armstrong",
  ...
  },
  {
    ...
    excerpt: "2023 marked Wi-Fi 6E's transition to mainstream enterprise standard while Wi-Fi 7 emerged from standards bodies toward commercial reality. As the industry prepares for 802.11be's 2024 arrival, mature 6 GHz deployments provide the foundation for next-generation wireless.",
    date: "2023-12-19",
    author: "Kris Armstrong",
