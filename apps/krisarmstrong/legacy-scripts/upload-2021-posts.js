...
const posts2021 = [
  {
    ...
    excerpt:
      "After spending 2020 deploying Wi-Fi 6 (802.11ax) networks across various enterprise environments, I've developed a comprehensive understanding of what works—and what doesn't—in real-world 802.11ax implementations.",
    date: '2021-01-18',
  ...
  },
  {
    ...
    excerpt:
      "The FCC's April 2020 decision to open 1200 MHz of spectrum in the 6 GHz band for unlicensed use represents the most significant expansion of Wi-Fi spectrum in history. Wi-Fi 6E promises to fundamentally change wireless network design and performance.",
    date: '2021-02-22',
    author: 'Kris Armstrong',
  ...
  },
  {
    ...
    excerpt:
      "WPA3, the latest Wi-Fi security protocol ratified by Wi-Fi Alliance in 2018, addresses fundamental vulnerabilities in WPA2 that have existed for over a decade. After spending 2020 evaluating WPA3 implementations, I've developed practical migration strategies.",
    date: '2021-03-16',
    author: 'Kris Armstrong',
  ...
  },
  {
    ...
    excerpt:
      "The COVID-19 pandemic accelerated a workplace transformation that was already underway: the shift to hybrid work models. As we move through 2021, it's increasingly clear that hybrid work isn't temporary—it's the new permanent reality.",
    date: '2021-04-19',
    author: 'Kris Armstrong',
  ...
  },
  {
    ...
    excerpt:
      'The enterprise wireless network management landscape is undergoing a fundamental transformation. Traditional on-premises controller architectures are rapidly giving way to cloud-managed platforms.',
    date: '2021-05-24',
    author: 'Kris Armstrong',
  ...
  },
  {
    ...
    excerpt:
      "Six months into 2021, Wi-Fi 6 deployments have matured significantly. However, realizing Wi-Fi 6's full performance potential requires more than simply installing 802.11ax access points—it demands careful optimization.",
    date: '2021-06-21',
    author: 'Kris Armstrong',
  ...
  },
  {
    ...
    excerpt:
      'Zero Trust has evolved from an abstract security concept to a practical framework reshaping enterprise network architecture. The hybrid work explosion of 2020-2021 has made zero trust migration from optional modernization to essential security requirement.',
    date: '2021-07-26',
    author: 'Kris Armstrong',
  ...
  },
  {
    ...
    excerpt:
      'Enterprise environments now support hundreds or thousands of IoT devices creating unprecedented capabilities—and massive security challenges. Wi-Fi 6 introduces capabilities specifically designed to support large IoT deployments.',
    date: '2021-08-23',
    author: 'Kris Armstrong',
  ...
  },
  {
    ...
    excerpt:
      'The evolution from traditional controller-based wireless management to cloud-managed platforms has fundamentally transformed network visibility and analytics capabilities, enabling proactive issue identification before users experience problems.',
    date: '2021-09-20',
    author: 'Kris Armstrong',
  ...
  },
  {
    ...
    excerpt:
      "After tracking Wi-Fi 6 client adoption throughout 2021, I've observed client ecosystems reaching the inflection point where Wi-Fi 6 density justifies infrastructure investment for efficiency gains rather than just future-proofing.",
    date: '2021-10-25',
    author: 'Kris Armstrong',
  ...
  },
  {
    ...
    excerpt:
      "Wi-Fi 6's efficiency improvements enable aggregate access point throughput that easily exceeds traditional gigabit Ethernet uplinks, creating a fundamental infrastructure challenge: wireless technology has outpaced the wired network supporting it.",
    date: '2021-11-22',
    author: 'Kris Armstrong',
  ...
  },
  {
    ...
    excerpt:
      "As 2021 draws to a close, it's time to reflect on a year characterized by maturation, optimization, and strategic planning. While 2020 was defined by pandemic urgency, 2021 was about thoughtful evolution of enterprise wireless infrastructure.",
    date: '2021-12-20',
    author: 'Kris Armstrong',
