...
- Acted as a key technical advisor, supporting the success of NetAlly's 50,000+ global customer base
...
- **Programming & Automation:** Python, Go, TypeScript/JavaScript, Ansible, CI/CD
- **Wireless Technologies:** RF Planning, Site Surveys, Spectrum Analysis, Capacity Planning, Roaming Optimization
- **Network Protocols:** BGP, OSPF, MPLS, SD-WAN, QoS, 802.1X, EAP
...
- Product Adoption & Customer Training
...
- Co-led go-to-market strategy for **CyberScope & CyberScope Air**, the first edge security scanners, securing **$1.2M in initial bookings** and establishing NetAlly as a security innovator
- Delivered 200+ live/virtual demos and tailored training workshops, accelerating product adoption and cutting customer onboarding time by **40%**
- Led post-sales security workshops for 50+ enterprise clients, boosting renewal rates and reducing time-to-competency by **40%**
...
- Designed training programs for 15+ engineers, cutting onboarding time by **40%** and boosting team efficiency
...
- Co-authored product roadmaps, contributing to a **15% annual revenue uplift** and faster time-to-market
...
- Optimized quality of service (QoS) and traffic engineering, reducing packet loss by **35%** and bandwidth costs by **25%**
...
- Implemented **Zero Trust** and next-gen firewalls, cutting security incidents by **70%** and earning **ISO 27001 certification**
...
- Conducted competitive analysis, driving features that increased early-adopter share by **25%**
- Managed go-to-market strategies, shortening sales cycles by **15%** and exceeding sales forecasts by **12%**
...
- **test-accessory-finder** - Network scanner for NetAlly Test Accessories running iPerf3 servers
- **niac-go** - Production-ready network device simulator with complete YAML configuration system
- **netally-tools** - Comprehensive toolkit for NetAlly hardware devices
- **eap-test-suite** - Automated testing suite for EAP authentication methods
- **network-tools** - Network discovery, listener, parser, and analysis tools
- **setup-podman-lab** - Full-featured local lab environment for developers and network engineers
...
**Languages:** Python, Go, TypeScript, JavaScript, Shell Scripting, SQL
**Frameworks:** React, Node.js, Vite, Tailwind CSS
**Cloud & DevOps:** AWS, Azure, Docker, Podman, Ansible, CI/CD, Git
**Networking:** Cisco, Aruba, Juniper, Fortinet, Palo Alto Networks, Ekahau, NetAlly
**Security:** CISSP, Zero Trust, Penetration Testing, Vulnerability Assessment, 802.1X, EAP
**Wireless:** Wi-Fi 6/6E/7, RF Design, Site Surveys, Spectrum Analysis, CWNA/CWDP/CWSP
